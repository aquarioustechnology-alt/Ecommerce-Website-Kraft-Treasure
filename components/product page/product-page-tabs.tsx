...
import { CircleCheckBig, PackageCheck, ShieldCheck, Truck } from "lucide-react"
...
export function ProductPageTabs({ product }: ProductPageTabsProps) {
  ...
  return (
    <section className="mx-auto w-full max-w-[1440px] px-6 py-12 lg:px-12 lg:py-14">
      <Tabs defaultValue="description" className="w-full gap-0">
        ...
        <TabsContent value="description" className="pt-0">
          <div className="grid gap-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:items-start">
            <div>
              <h2 className="mb-4 text-2xl font-serif leading-tight text-foreground lg:text-3xl">
            ...
            <div>
              ...
              <p className="mb-4 text-[10px] font-sans uppercase tracking-[0.24em] text-muted-foreground">
                What Defines This Piece
              </p>
              <ul className="space-y-3">
                {descriptionBullets.slice(0, 4).map((item) => (
                  <li key={item} className="flex items-start gap-3 text-sm font-sans leading-relaxed text-muted-foreground">
